    ...
    while in_esecuzione:
        ...
        for evento in pygame.event.get():
            ...
            # Tasto premuto
                ...
                if evento.key == pygame.K_SPACE and stato_gioco == "VINCITORE" and not mostra_classifica:
                    stato_gioco = "MENU"
            ...
            # Click del mouse
                ...
                # CLICK SULLA CLASSIFICA (bottone CONTINUA)
                    ...
                    if bottone_classifica_continua and bottone_classifica_continua.collidepoint(pos_mouse):
                        mostra_classifica = False
                        stato_gioco = "MENU"
        ...
        if stato_gioco == "GIOCANDO":
            ...
            if conto_alla_rovescia <= 0:
                ...
                if len(lottatori_vivi) == 1:
                    ...
                    if difficolta == "DIFFICILE" and not vincitore['è_bot'] and utente_loggato:
